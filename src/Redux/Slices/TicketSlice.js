...
//downloaded ticket list=original
//filter ticket list for  specid=fic status
...
//fetching all tickets in database
...
//getting specific ticket for update
...
const ticketSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        .addCase(getAllTicketsforTheUser.fulfilled, (state, action) => {
            ...
            //creating 2 ticket list for original and on basis of status
