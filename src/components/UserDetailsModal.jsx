    ...
    async function handleUserChange(e) {
        try {
            ...
            const response = await axiosInstance.patch("user/updateUser", {
                ...
                updates: {
                    ...userDisplay,
                    //square bracket mai dalne se name  evaluate hoga as a key
                ...
                <p className="py-4">Status: 
                    <span className="text-yellow-500"> 
                        <details className="dropdown ml-2" id="userStatusDropdown">
                            ...
                            {/* //we are passing name so that handle userchange is able to understand whether the change was for status or for the type */}
